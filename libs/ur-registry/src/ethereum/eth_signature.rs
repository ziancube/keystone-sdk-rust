...
use crate::registry_types::{RegistryType, ETH_SIGNATURE, UUID};
...
mod tests {
    ...
    fn test_encode() {
        ...
        .to_vec();
        let eth_signature =
            EthSignature::new(request_id, signature, Some("keystone".to_string()), None);
        assert_eq!(
    ...
    fn test_decode() {
        ...
        assert_eq!(
            ...
            eth_signature.get_request_id().unwrap()
        );
        assert_eq!(
            [
